...
public partial class Q1Cpu
{
    ...
    private void LoadInstructionLookup()
    {
        this.InstructionLookup = new Dictionary<u8, (Action, Action<u8>, Action, Action<u8, u8>)>
        {
            ...
            { 0x03, (this.Instruction_NOP, this.Instruction_PUSH, this.Instruction_NOP, this.Instruction_NOP) },
    ...
    public void Instruction_PUSH(u8 m1)
    {
        u16 value = this.Address(m1).read();
        this.PushStack(value);
    }
    
    public void Instruction_POP(u8 m1)
    {
        u16 value = this.PopStack();
        this.Address(m1).write(value);
    }
}